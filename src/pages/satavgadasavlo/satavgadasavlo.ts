...
/**
 * Generated class for the SatavgadasavloPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-satavgadasavlo',
  templateUrl: 'satavgadasavlo.html',
})
export class SatavgadasavloPage {
  ...
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    ...
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=satavgadasavlo')
    .map(res => res.json())
    .subscribe(res => {
