...
/**
 * Generated class for the TrileriPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-trileri',
  templateUrl: 'trileri.html',
})
export class TrileriPage {
  ...
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    ...
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=trileri')
    .map(res => res.json())
    .subscribe(res => {
