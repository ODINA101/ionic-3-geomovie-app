...
/**
 * Generated class for the AnimaciuriPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-biografiuli',
  templateUrl: 'biografiuli.html',
})
export class BiografiuliPage {
movies = [];
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    let loader = this.loadingCtrl.create({
      content: "იტვირთება...",
                   ...
                   loader.present();
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=biografiuli')
    .map(res => res.json())
    .subscribe(res => {
