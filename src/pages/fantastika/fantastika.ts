...
/**
 * Generated class for the FantastikaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-fantastika',
  templateUrl: 'fantastika.html',
})
export class FantastikaPage {
  ...
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    let loader = this.loadingCtrl.create({
      content: "იტვირთება...",
        ...
        loader.present();
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=fantastika')
    .map(res => res.json())
    .subscribe(res => {
  this.movies = res;
  loader.dismiss();
