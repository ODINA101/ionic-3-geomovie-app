...
/**
 * Generated class for the IstoriuliPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-istoriuli',
  templateUrl: 'istoriuli.html',
})
export class IstoriuliPage {
  movies = [];
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    ...
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=istoriuli')
    .map(res => res.json())
    .subscribe(res => {
