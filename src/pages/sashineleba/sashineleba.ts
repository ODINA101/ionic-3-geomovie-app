...
/**
 * Generated class for the SashinelebaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sashineleba',
  templateUrl: 'sashineleba.html',
})
export class SashinelebaPage {
  movies = [];
  constructor(public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams,public http:Http,public alertCtrl:AlertController) {
    ...
    let loader = this.loadingCtrl.create({
      content: "იტვირთება...",
        ...
        loader.present();
    this.http.get('https://myionicapp.000webhostapp.com/api.php?q=sashineleba')
    .map(res => res.json())
    .subscribe(res => {
